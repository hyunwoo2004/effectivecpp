...
// 이렇게 할 수 있는 문법도 없음 혹시 이런 방법이 가능해 '보이는' 방법을 본 것 같은 건 헛소리에 불과함
// 암울했던 지난날의 방법으로 어떻게든 하기는 하는 문법이 있다는 사실은 알고 있지만, 그런 문법을 사용하면
// 특정한 조건에서 객체의 데이터가 훼손되어 버릴 수 있어서 매우 위험함!
